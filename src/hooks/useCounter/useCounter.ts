 ...
 * @param {number} initialValue Initial value for the counter
 ...
 * @throws Will throw an error if intial value is less than provided {@link UseCounterOptions.min} or greater than {@link UseCounterOptions.max}
